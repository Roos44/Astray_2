...
namespace SETUtil.ResourceLoader
{
	...
	/// </summary>
	[U.CreateAssetMenu(menuName = "Resource Link/Texture Resource")]
	public class TextureResource : U.ScriptableObject
	{
		[System.Serializable]
		...
		public static U.Texture2D Get (string name)
		{
			...
			var _scriptableObjects = E.AssetDatabase.FindAssets("t:TextureResource").Select(
				a => E.AssetDatabase.LoadAssetAtPath<TextureResource>(E.AssetDatabase.GUIDToAssetPath(a)));
