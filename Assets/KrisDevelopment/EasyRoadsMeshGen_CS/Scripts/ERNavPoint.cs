	...
	public class ERNavPoint : MonoBehaviour
	{
		...
		public void LockSize(bool state)
		{
			using (SerializedObject so = new SerializedObject(this))
			{
				...
				SerializedProperty so_lockedWidth = so.FindProperty("lockedHalfWidth");
				...
				else
				{
					...
					so_lockedWidth.floatValue = assignedMeshGen.halfDeltaWidth;
				}
		...
		public void SetIndex(int index)
		{
			...
			using (SerializedObject so = new SerializedObject(this))
			{
				SerializedProperty so_index = so.FindProperty("lastKnownIndex");
